...
import AddDastavshikModal from '../components/AddDastavshikModal';
...
export default function DastavshiklarPage() {
    ...
    const filteredProfiles = profilesList.filter(profile =>
        ...
        profile.firma.toLowerCase().includes(searchQuery.toLowerCase())
    );

    const handleAddDastavshik = (data: { name: string; surname: string; phone: string; firma: string }) => {
        const newProfile = {
            id: Date.now(),
            ...data
        };
        ...
        <div className="flex h-screen w-full overflow-hidden bg-white">
            ...
            <main className="flex-1 overflow-y-auto p-4 md:p-8 bg-gray-50/50">
                <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-8 mt-16 lg:mt-0">
                    <div>
                        <h1 className="text-2xl md:text-3xl font-extrabold text-gray-900">Dastavshiklar</h1>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    ...
                    <div 
                    className="bg-white/40 border-2 border-dashed border-gray-300 rounded-xl flex flex-col items-center justify-center p-6 text-gray-400 font-bold hover:bg-white/60 transition-colors cursor-pointer min-h-[250px]"
